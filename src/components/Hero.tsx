    ...
    <section id="home" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10 grid lg:grid-cols-[1.2fr_0.8fr] gap-12 items-center">
        <div className="flex flex-col items-start">
          ...
          >
            Building digital experiences that <span className="text-accent italic font-serif">feel</span> as good as they work.
          </motion.h1>
          ...
          >
            I build modern web applications and intelligent systems across the frontend, backend, and AI-powered automation.
          </motion.p>
          ...
          >
            <a href="https://github.com/haseebjaved4212" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="GitHub">
              <Github className="w-5 h-5" />
            </a>
            <a href="https://www.linkedin.com/in/haseeb-javed-0332b3341/" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="LinkedIn">
              <Linkedin className="w-5 h-5" />
            </a>
            <a href="https://x.com/Haseebjaved4212" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="Twitter">
